...
// Theme is now driven by SettingsBloc. Removed ThemeCubit import.
import 'package:engaz_task/app/core/routing/app_router.dart';
import 'package:engaz_task/app/core/services/theme_service.dart';
import 'package:engaz_task/app/core/widgets/shared_widgets/custom_title_bar.dart';
  ...
  Widget build(BuildContext context) {
    ...
    return BlocBuilder<SettingsBloc, SettingsState>(
      ...
      builder: (context, settingsState) {
        ...
        final locale = settingsState.settings.language.locale;
...
class _LocalizedApp extends StatelessWidget {
  ...
  /// Custom app builder to apply common UI elements
